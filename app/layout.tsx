...
export const metadata: Metadata = {
  ...
  description:
    "Mingo Hotel Uganda is a charming 5-star hotel located in the heart of Kayunga, Uganda. Blending modern comfort with local warmth, the hotel offers cozy rooms, exceptional dining, and convenient access to top attractions like Mehta Golf Club and the Source of the Nile.",
};
